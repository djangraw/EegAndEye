...
%
% -If only x is given as an input, plots the distance from the eye to the 
% object at the end of every saccade.
% -If samples is also given, plots the distance from the eye to the object
% every sample.
% -If pupilsize is also given, plots the size of the pupil over time.
%
...
MakeLegend({'b','r'},{'Targets','Distractors'});