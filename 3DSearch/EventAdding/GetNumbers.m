...
if when>datenum('July 1, 2011') % 3DSearch_6pt2 has specific buttons
    ...
    Numbers.GAMEPAD_TARGET_BUTTON = 1:10; % any button indicated a target was seen
    Numbers.GAMEPAD_BRAKE_BUTTON = []; % brake button didn't exist
end
