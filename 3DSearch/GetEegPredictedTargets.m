...
trialNumbers(truth==1) = 1:nTargets; % the trial number (in EEG struct) for each element of p and truth
trialNumbers(truth==0) = 1:nDistractors; % the trial number (in EEG struct) for each element of p and truth

% sort trials
[~, order] = sort(y,'descend'); % sort trials in order of descending probability of being a target
