...
%% Save results
save TopLevelGlmResults_Target group_* contrast* events event_weights baseline_win iLevel multcorrect tResponse chanlocs 
...
%% Plot Scalp Maps
tBinCenters = [275 425 575];%37.5:75:500;
tBinWidth = 50;%75;
