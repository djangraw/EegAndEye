function [y, w, v, fwdModel, y_level1] = RunHdcaClassifier(data, truth, trainingwindowlength, trainingwindowoffset, cvmode, fwdModelData)

% Run a hierarchical classifier similar to those in LIINC RSVP experiments.
%
% [y, w, v, fwdModel, y_level1] = RunHdcaClassifier(data, truth, trainingwindowlength,
